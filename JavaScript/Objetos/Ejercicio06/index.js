...
let mostrar = window.prompt("Escribe el nombre")

if (mostrar === personas[BridgetteMcGuire]) {
    div1.innerHTML = `<p>${personas.BridgetteMcGuire.picture}</p>
                      ...
                      <p>${personas.BridgetteMcGuire.balance}</p>
