...
//let fecha = window.prompt("Escribe la fecha de nacimiento dd-mm-aaaa");
let nombre = window.prompt("Escribe tu nombre");
// let apellido = window.prompt("Escribe tu apellido");
// let nombreGenero = window.prompt("Nombre masculino o femenino");

let generadorNombre = nombre.substring(0, 1);
// let generadorApellido = apellido.substring(apellido.length-1, apellido.length);
// let generadorFecha = fecha.substring(fecha.length-1, fecha.length);

let nombreSuper = letraNombre.generadorNombre